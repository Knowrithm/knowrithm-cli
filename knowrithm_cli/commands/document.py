...
def list_documents(auth: str, page: int, per_page: int) -> None:
...
@click.option("--page", default=1, type=int)
@click.option("--per-page", default=20, type=int)
def agent_documents(auth: str, agent_id: str, page: int, per_page: int) -> None:
...
def delete_document(auth: str, document_id: str) -> None:
...
@auth_option()
@click.argument("document_id")
def restore_document(auth: str, document_id: str) -> None:
...
@auth_option()
@click.argument("document_id")
def delete_chunks(auth: str, document_id: str) -> None:
...
@auth_option()
@click.argument("document_id")
def restore_chunks(auth: str, document_id: str) -> None:
...
def delete_chunk(auth: str, chunk_id: str) -> None:
...
@auth_option()
@click.argument("chunk_id")
def restore_chunk(auth: str, chunk_id: str) -> None:
...
@cmd.command("deleted")
@auth_option()
def deleted_documents(auth: str) -> None:
...
@auth_option()
def deleted_chunks(auth: str) -> None:
...
def search(auth: str, payload: str) -> None:
